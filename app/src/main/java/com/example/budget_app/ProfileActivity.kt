...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun updateUsername(username: String) {
        ...
        database.getReference(Constants.PATH_USERS).child(userId).child(Constants.PATH_PROFILE).child("username").setValue(username)
    ...
    private fun updateProfilePicture(uriString: String) {
        ...
        database.getReference(Constants.PATH_USERS).child(userId).child(Constants.PATH_PROFILE).child("profilePic").setValue(uriString)
    }
}