...
class CategoryActivity : AppCompatActivity() {
    ...
    private fun fetchUserProfile() {
        ...
        val userRef = database.getReference(Constants.PATH_USERS).child(user.uid).child(Constants.PATH_PROFILE)
    ...
    private fun saveCategoryToFirebase(name: String, description: String) {
        ...
        val categoryRef = database.getReference(Constants.PATH_USERS).child(userId).child(Constants.PATH_CUSTOM_CATEGORIES).push()
    ...
    private fun fetchCategories() {
        ...
        val customCategoriesRef = database.getReference(Constants.PATH_USERS).child(userId).child(Constants.PATH_CUSTOM_CATEGORIES)
        ...
        customCategoriesRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@CategoryActivity, "Error loading categories: ${error.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    inner class CategoryAdapter(private val items: List<CategoryModel>) :
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            try {
                ...
                holder.cvIconBackground.setCardBackgroundColor(ContextCompat.getColor(this@CategoryActivity, R.color.primary_blue))
            }
        }
