...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<MaterialButton>(R.id.btn_add_account_main).setOnClickListener {
            startActivity(Intent(this, AddAccountActivity::class.java))
        }

        findViewById<MaterialButton>(R.id.btn_track_spending_main).setOnClickListener {
    ...
    private fun fetchAccounts() {
        ...
        accountsRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                // Re-add the "Add Account" button at the end
                val addAccountBtn = MaterialButton(this@MainActivity, null, com.google.android.material.R.attr.materialButtonOutlinedStyle).apply {
                    text = "+ Add Account"
                    setOnClickListener {
                        startActivity(Intent(this@MainActivity, AddAccountActivity::class.java))
                    }
                }
                llAccountContainer.addView(addAccountBtn)
            }
    ...
    private fun addAccountCard(account: Account) {
        val cardView = CardView(this).apply {
            ...
            radius = 32f
            setCardBackgroundColor(Color.parseColor("#0056D2"))
