...
class activity_creategoal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // FIX: Using explicit regional URL to prevent silent disconnects
        ...
        btnSaveGoal.setOnClickListener {
            ...
            Toast.makeText(this, "Save requested...", Toast.LENGTH_SHORT).show()
            saveGoal()
        }
    }
    ...
    private fun saveGoal() {
        ...
        val goalRef = database.getReference("users").child(user.uid).child("goals").push()
